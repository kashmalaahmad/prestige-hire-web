...
import { FormalHireSection } from "@/app/services/formal-car-hire/FormalHireSection";
import { year12Formal } from "@/lib/services/formal-car-hire";
import { Year12FormalSection } from "@/app/services/formal-car-hire/Year12FormalSection";
...
export default function FormalCarPage() {
  ...
  return (
    <main>
      ...
      <FormalHireSection data={data.typesSection} />
      <Year12FormalSection data={year12Formal} />
