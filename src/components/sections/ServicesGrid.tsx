  ...
  return (
    <div className="flex flex-col rounded-xl overflow-hidden bg-white border-2 border-white shadow-sm hover:shadow-lg transition-shadow duration-300 h-full">
      ...
      <div className="p-4 sm:p-6 flex flex-col flex-grow">
        ...
        <p className="font-body text-[16px] text-[#595959] mb-4 sm:mb-6 flex-grow leading-relaxed" style={{ fontFamily: "Poppins, sans-serif" }}>
          {service.description}
        </p>
        <Link
          href={service.link}
    ...
    <section className="w-full py-[36px] sm:py-[48px] md:py-[60px] bg-white">
      <div className="w-full px-2 sm:px-4">
        <div className="text-center mb-8 md:mb-16 px-4">
          <h2
            className="text-[55px] font-bold text-[#515151] leading-tight mb-4 md:mb-10"
